 ...
 const JEELIZFACEFILTERGEN = function() {
    function Kb(a) {
        ...
        "undefined" !== typeof a && (q = Object.assign({},
            n, a), this.A())
    }
    ...
    function Nb(a) {
        if ("undefined" === typeof gb(a).nb) {
            ...
            var d = c.nf,
                h = c.n;
            c = ub(c);
            for (var k = new Float32Array(h),
                    p = new Float32Array(d), q = a + d + 1, n = 0; n < h; ++n) {
                var l = q * n,
                    t = 0 === fb(c, l) ? 1 : -1,
                    w = tb(c, l + 1, a);
                l = l + 1 + a;
    ...
    function vb() {
        na !== ja.pause && (ba.isCleanGLStateAtEachIteration && (D.kd(),
            Q.reset(), Q.Ca(), b.disable(b.DEPTH_TEST), b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, !1), D.Ka()), qa.Fc(Pb, Ob, Qb, xb, Rb, ba.animateProcessOrder))
    }

    function Pb() {
        sa.fa();
        if (!J.Ab)
            if (J.zb) J.element.needsUpdate && (J.D.ie(J.element.videoWidth, J.element.videoHeight), J.D.Sb(J.element.arrayBuffer), J.element.needsUpdate = !1);
            else {
        ...
        for (var a = 0; a < da.qa(); ++a)
            if (da.Jf(a)) {
                ...
                if (d.kb < ba.multiDetectionThresholdFactors[0] * ba.threshold) d.ua = Math.floor(d.ua / 2), S.Ea && (k.rz = 0, k.ry = 0);
                    ...
                    n = qa.ff();
                    h = (1 - $a.Fb(ta.translationFactorRange[0], ta.translationFactorRange[1], Math.sqrt(h.dx *
                        h.dx + h.dy * h.dy + h.ec * h.ec) / n)) * (1 - $a.Fb(ta.rotationFactorRange[0], ta.rotationFactorRange[1], Math.sqrt(h.bc * h.bc + h.cc * h.cc + h.dc * h.dc) / n)) * $a.Fb(ta.qualityFactorRange[0], ta.qualityFactorRange[1], d.kb);
                    c = p[++kb[c] % p.length] = h;
                    ...
                    k.rz = S.Ea ? k.rz + ta.followZRotAlphaFactor *
                        p * d.xa : wa.aa(k.rz, d.xa, p);
    ...
    function zb() {
        ...
        var a = {
            ...
            isFloat: !0,
            isPot: !1,
            array: da.Ue(new Float32Array([0, .5, .5, 0, 0, 0, 0, 0, 0, 0, 0, 0]))
        };
        V.ya = Sb.instance(a)
    }
    ...
    function lb() {
        ...
        D.T("s65", [{
            ...
            type: "3f",
            name: "u48",
            value: [V.P[0] * Z.G[0], V.P[1] * Z.G[1], V.P[2]]
        }, {
            type: "1f",
            name: "u43",
            value: .5
    ...
    function mb() {
        ...
        Z.G[1] = Z.u / Z.N;
        Ta.A({
            Jb: ba.overlapFactors,
            Vd: ba.nScaleLevels,
            u: Z.u,
            N: Z.N,
            de: ba.scale0Factor,
            P: V.P,
            Hc: ba.scanCenterFirst
        })
    }
    ...
    function Ab(a, c) {
        ...
        V.ba || (V.ba = ea.Ud);
        if (!V.Da)
            for (V.Da = [], d = 0; d < V.ba; ++d) V.Da.push(ea.$e);
        c(a)
    }
    ...
    function Vb() {
        ...
        D.gg("u47", Ta.get(a));
        Q.l(!1, !1);
        if (da.Md() || h) b.viewport(1,
            a, 1, 1), D.set("s66"), D.I("u51", d), Q.l(!1, !1);
    ...
    function Bb() {
        ...
        J.Mc = aa.instance(Object.assign({
            isPot: !1,
            isLinear: !0,
            isFloat: !1
        }, a));
    ...
    function Cb() {
        var a = {
            w: J.element.videoWidth || J.element.width,
            Ga: J.element.videoHeight ||
                J.element.height
        };
    ...
    function Db(a, c, d) {
        ...
        X.get(J.element ? J.element : X.Ad(), function(h) {
            c && c(h);
            d(h)
        }, function() {
    ...
    var wa = {
        ...
        D = function() {
            ...
            function d(e) {
                return ["float", "sampler2D", "int"].map(function(m) {
            ...
            function h(e, m) {
                ...
                if (!m.o) {
                    ...
                    m.id = w++;
                    void 0 !== m.ge && (m.ge.forEach(function(P, fa) {
            ...
            function k(e) {
                xa.eg(N);
                l !== e.id && (N.R(), l = e.id, t = e, b.useProgram(e.wa), e.Qa.forEach(function(m) {
            ...
            var n = [],
                ...
                N = {
                    ...
                    xf: function(e,
                        ...
                        v[m].Df = !0;
                        O[e].Nb && O[e].Nb.forEach(function(M, P) {
                            var fa = "";
            ...
            var p = null,
                ...
                x = {
                    ...
                    rh: function() {
                        ...
                        for (var r = x.ef(), F = n.createImageData(q.width,
                                q.height), C = q.width, f = q.height, E = F.data, K = 0; K < f; ++K)
        ...
        za = function() {
            ...
            function c(e) {
                ...
                var m = e >> 16 & 32768,
                    H = e >> 12 & 2047,
                    M = e >> 23 & 255;
                return 103 > M ? m : 142 < M ? m | 31744 | ((255 == M ? 0 : 1) && e & 8388607) : 113 > M ? (H |= 2048, m | (H >> 114 - M) + (H >> 113 - M & 1)) : m = (m | M - 112 << 10 | H >> 1) + (H & 1)
            }
            ...
            var q = 0,
                ...
                N = {
                    A: function() {
                        C || (r = [b.RGBA, null, b.RGBA, b.RGBA], F = [b.RGBA, null, b.RGBA, b.RGBA], n = [b.TEXTURE0, b.TEXTURE1, b.TEXTURE2, b.TEXTURE3, b.TEXTURE4, b.TEXTURE5, b.TEXTURE6, b.TEXTURE7], u = "undefined" !== typeof JEContext, I = "undefined" !== typeof Y, u && JEContext.Rh() && n.push(b.TEXTURE8, b.TEXTURE9), t = [-1, -1, -1, -1, -1, -1, -1, -1], x = [b.UNSIGNED_BYTE, b.FLOAT, b.FLOAT], C = !0)
                    },
                    wf: function() {
                        if (!w) {
                            for (var e = new Float32Array(16384), m = 0; 16384 >
                                m; ++m) e[m] = 2 * Math.random() - 1;
                            w = {
                                random: N.instance({
                                    isFloat: !0,
                                    isPot: !0,
                    ...
                    Zh: function(e, m) {
                        N.ce(e);
                        b.readPixels(0, 0,
                            e.K(), e.W(), b.RGBA, b.UNSIGNED_BYTE, m)
                    },
                    $h: function(e, m) {
                        N.ce(e);
                    ...
                    instance: function(e) {
                        ...
                        function H() {
                            T = void 0 !== B.J.videoWidth ?
                                B.J.videoWidth : B.J.width;
                        ...
                        function P() {
                            if (!Eb) {
                                ...
                                B.isPot ? (b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_S, B.isMirrorX ? b.MIRRORED_REPEAT : b.REPEAT), b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_T,
                                    B.isMirrorY ? b.MIRRORED_REPEAT : b.REPEAT)) : (b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_S, b.CLAMP_TO_EDGE), b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_T, b.CLAMP_TO_EDGE));
                                B.isAnisotropicFiltering && "undefined" !== typeof JESETTINGS && b.texParameterf(b.TEXTURE_2D, JEContext.sh().TEXTURE_MAX_ANISOTROPY_EXT, JESETTINGS.yg);
                                b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MAG_FILTER, B.isLinear ? b.LINEAR : b.NEAREST);
                                var G = B.isMipmap && !Qa;
                                b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MIN_FILTER, B.Jd ? b.LINEAR_MIPMAP_LINEAR : B.isLinear ?
                                    G ? b.NEAREST_MIPMAP_LINEAR : b.LINEAR : G ? b.NEAREST_MIPMAP_NEAREST : b.NEAREST);
                                ha = r[B.Gb - 1];
                                ka = F[B.Gb - 1];
                                ia = x[pb];
                                Y.na() && (G = Y.gf(), ha === b.RGBA && ia === b.FLOAT ? B.isMipmap || B.isLinear ? ka = Aa.jf(b) : Y.bd() ? G && (ka = G) : ka = b.RGBA16F || b.RGBA : ha === b.RGB && ia === b.FLOAT && G && (ka = G, ha = b.RGBA));
                                ...
                                if (B.J) M(B.J);
                                    ...
                                    try {
                                        "FUCKING_BIG_ERROR" !== b.getError() && (b.texImage2D(b.TEXTURE_2D,
                                            0, ka, T, U, 0, ha, ia, G), b.getError() !== b.NO_ERROR && (b.texImage2D(b.TEXTURE_2D, 0, ka, T, U, 0, ha, ia, null), b.getError() !== b.NO_ERROR && b.texImage2D(b.TEXTURE_2D, 0, b.RGBA, T, U, 0, b.RGBA, b.UNSIGNED_BYTE, null)))
                                    } catch (kc) {
                                        b.texImage2D(b.TEXTURE_2D, 0, ka, T, U, 0, ha, ia, null)
                                    }
                                    B.isKeepArray || (va = null)
                                } else G = b.getError(), "FUCKING_BIG_ERROR" !== G && (b.texImage2D(b.TEXTURE_2D, 0, ka, T, U, 0, ha, ia, null), G = b.getError(), G !== b.NO_ERROR && (ha = b.RGBA, B.S && ia !== b.FLOAT && (ia = b.FLOAT, b.texImage2D(b.TEXTURE_2D, 0, ka, T, U, 0, ha, ia, null))));
                                if (B.isMipmap)
                                    if (!Qa &&
                                        ca) ca.sb(), db = !0;
                                    else if (Qa) {
                        ...
                        function fa() {
                            for (var G = T * U, R = 2 * G, la = 3 * G, W =
                                    0; W < G; ++W) ya[0][W] = Va[W], ya[1][W] = Va[W + G], ya[2][W] = Va[W + R], ya[3][W] = Va[W + la]
                        }
                        ...
                        var B = Object.assign({}, E, e),
                            Xa = l++;
                        null === B.isFlipY && (B.isFlipY =
                            B.url ? !0 : !1);
                        B.data && (B.array = "string" === typeof B.data ? Nb(B.data) : B.isFloat ? new Float32Array(B.data) : new Uint8Array(B.data), B.isFlipY = !1);
                        var pb = 0,
                            Gb = B.J ? !0 : !1,
                            Ya = null,
                            rb = null,
                        ...
                        var ca = {
                            ...
                            bf: function(G) {
                                ...
                                if (Qa) {
                                    D.set("s12");
                                    N.Vb(0);
                                    for (var R = T, la = U, W = 1; W <= G; ++W) R /= 2, la /= 2, D.V("u14", .25 / R, .25 / la), b.viewport(0, 0, R, la), a(Ra[W - 1]), b.framebufferTexture2D(oa.jc(), b.COLOR_ATTACHMENT0, b.TEXTURE_2D, Ra[W], 0), ma.l(!1, 1 === W);
                                    t[0] = -1
                            ...
                            gd: function(G) {
                                ...
                                D.set("s15");
                                ca.h(0);
                                if (G) b.viewport(0, 0, T, U), D.hg("u15", .25, .25, .25, .25), ma.l(!1, !0);
                                else
                                    for (G = 0; 4 > G; ++G) b.viewport(0, U * G, T, U), D.le("u15", g[G]), ma.l(!1, 0 === G)
                            },
                            Sb: function(G) {
                                var R = ia === x[0] && !k();
                                a(ra);
                                Ba && b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, !0);
                                R ? (Hb || (Ya = document.createElement("canvas"), Ya.width = T, Ya.height = U, rb = Ya.getContext("2d"), rb.createImageData(T, U), Hb = !0), null.data.set(G), rb.putImageData(null, 0, 0), b.texImage2D(b.TEXTURE_2D,
                                    0, ka, ha, ia, Ya)) : b.texImage2D(b.TEXTURE_2D, 0, ka, T, U, 0, ha, ia, G);
                                t[q] = Xa;
                                Ba && b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, !1)
                            },
                            ui: function(G, R) {
                                ...
                                Wa || ("RGBA" === G || "RGBE" ===
                                    G || "RGBAARRAY" === G ? (Ea = new Uint8Array(W), Wa = !0) : "JSON" !== G || R || ua());
                                oa.M();
                                D.set(La);
                                ca.h(0);
                                W = null;
                                if ("RGBA" === G || "RGBE" === G || "RGBAARRAY" === G) {
                                    ...
                                    if (R) W = new Float32Array(la), b.viewport(0, 0,
                                        T, U), ma.l(!0, !0), b.readPixels(0, 0, T, U, b.RGBA, b.FLOAT, W);
                                    else {
                                    ...
                                    height: U,
                                    isMirrorY: B.isMirrorY,
                                    isFlipY: "RGBA" === G ? B.isFlipY : !B.isFlipY
                                }
                            }
                        };
                        B.isMipmap && !Qa && Ua && !db && (ca.sb(), db = !0);
                        if (B.url) a(ra), b.texImage2D(b.TEXTURE_2D, 0, b.RGBA, 1, 1, 0, b.RGBA, b.UNSIGNED_BYTE, null), Ga = new Image, Ga.Ng = "Anonymous", Ga.crossOrigin =
                            ...
                            Jb()
                        } else B.array ? (B.S && !B.isFloat ? B.array instanceof Uint16Array ? (va = B.array, P()) : h() ? (va = d(B.array), P()) : (P(), N.td(b, ra, ca.K(), ca.W(), B.array, Ba, !0)) : (va = B.isFloat ? B.array instanceof Float32Array ? B.array : new Float32Array(B.array) : B.array instanceof Uint8Array ? B.array : new Uint8Array(B.array), P()), B.isKeepArray || (va && va !== B.array && (va = null), delete B.array)) : B.lc ? Ua = !0 : P();
                        ca.Ch = ca.K;
                    ...
                    ti: function(e, m) {
                        ...
                        } else "JSON" === e.format ? m(N.instance({
                                isFloat: !0,
                                isFlipY: e.isFlipY,
                                width: e.width,
                                height: e.height,
        ...
        ma = function() {
            ...
            var c = null,
                ...
                n = {
                    ...
                    Ca: function() {
                        -1 !== p && (b.bindBuffer(b.ARRAY_BUFFER, c.da), p = -1); - 1 !== q && (b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, c.indices), q = -1)
                    },
                    l: function(l, t) {
                        l && ma.Ca();
                        t && xa.Ka();
                ...
                q = {
                    ...
                    instance: function(n) {
                        ...
                        var f = {
                            ...
                            remove: function() {
                                y === a || F || (b.bindFramebuffer(c, y), b.framebufferTexture2D(c, b.COLOR_ATTACHMENT0, b.TEXTURE_2D,
                                    null, 0), x && b.framebufferRenderbuffer(c, b.DEPTH_ATTACHMENT, b.RENDERBUFFER, null), b.bindFramebuffer(c, null), p.H = -1, b.deleteFramebuffer(y), x && b.deleteRenderbuffer(x));
                                F = !0
                            }
                        };
                        n.Ed && f.we();
        ...
        Y = function() {
            ...
            function h(g) {
                if (0 === f.ra.length) {
                    ...
                    f.ra.splice(0);
                    f.ub.splice(0);
                    for (var u = 0; u < f.Ta; ++u) f.ra.push(b.createBuffer()),
                        f.ub.push(-1);
                    f.ja = 0;
                    f.xc = 0
                }
            ...
            var n = null,
                ...
                z = {
                    ...
                    Pb: function(g, u, I) {
                        ...
                        L();
                        for (I = 0; 36 > I; ++I)
                            if (3 !== I % 4 && 3 < Math.abs(u[I] - 127)) return !1;
                        return !0
                    },
                    $b: function(g) {
                        var u = {
                    ...
                    Se: function() {
                        var g = !1;
                        z.na() && (g = "PIXEL_PACK_BUFFER STREAM_READ SYNC_GPU_COMMANDS_COMPLETE WAIT_FAILED fenceSync deleteSync createBuffer".split(" ").every(function(u) {
                            ...
                            function M() {
                                ...
                                switch (b.clientWaitSync(f.Fa[P], 0, 0)) {
                                    ...
                                    case b.WAIT_FAILED:
                                        break;
                                    default:
                                        return d(), b.deleteSync(f.Fa[P]), f.Fa[P] = null, b.bindBuffer(f.X, f.ra[P]), b.getBufferSubData(f.X, 0, v), k(), q(), m(v, e), !0
                                }
                                f.Rb = setTimeout(M, 0);
                                return !1
                            }
        ...
        Aa = function() {
            function a(g, u, I, L) {
                f.texParameteri(f.TEXTURE_2D,
                    f.TEXTURE_MIN_FILTER, L ? f.NEAREST_MIPMAP_NEAREST : f.LINEAR);
                var v = null;
                if (null !== I) try {
                    v = f.getError();
                ...
                v = f.getError();
                v === f.INVALID_OPERATION && "undefined" !== typeof f.PIXEL_PACK_BUFFER && (f.bindBuffer(f.PIXEL_PACK_BUFFER,
                    null), f.readPixels(0, 0, 2, 2, f.RGBA, f.UNSIGNED_BYTE, w), v = f.getError());
                if (v !== f.NO_ERROR) return !1;
                I = !0;
            ...
            for (var q = {
                    ...
                    Dd: null,
                    lb: null
                }, t = !0, w = new Uint8Array(16), y = Array(64), x = 0; 4 > x; ++x)
                for (var r = 0; 4 > r; ++r) {
                    var F = 0 === (r + x) % 2 ? 1 : 0,
                        C = 4 * x + r;
                    y[4 * C] = F;
        ...
        Lb = function() {
            return {
                instance: function(a) {
                    ...
                    a.mask && (h = !0, ea && void 0 !== ea.Ae && (a.mask = ea.Ae + a.mask), d = aa.instance({
                        isFloat: !1,
                        url: a.mask
                    }));
                    var y = !1;
            ...
            return {
                instance: function(a) {
                    ...
                    var k = {
                        ...
                        r = 1 / a.size;
                    a.Ef ? (a.sparsity = "undefined" !== typeof a.sparsity ? a.sparsity : a.Kb.kc(), q = !1) : "full" === a.connectivityUp && (a.sparsity = a.Kb.kc());
                    var F = {
                            elu: "s19",
                            elu01: "s20",
                            relu: "s17",
                    ...
                    var g = {
                        ...
                        dg: function() {
                            switch (a.connectivityUp) {
                                ...
                                case "squareFast":
                                    ...
                                    break;
                                case "full":
                                    z = fc.instance(Object.assign({
                                        Ya: a.Ya
                                    }, a.connectivity));
                                    break;
                                case "conv":
                                    l = a.kernelsCount, z = gc.instance(a.connectivity), t && (k.Dc = aa.instance({
                                        width: E,
                                        isFloat: !0,
                                        isFlipY: !1,
                                        isPot: !1
                        ...
                        U: function(u,
                            I) {
                            p = u;
                            z.La ? (k.input.L(), w && k.bias.h(2), z.U(x), k.input.h(0), k.input.bf(A), k.xb.L(), w ? D.set("s0") : (D.set(y), D.I("u4", C), k.bias.h(1)), k.input.De(A, 0), Q.l(!1, !1), D.set(F), k.va.v(), k.xb.h(0), Q.l(!1, !1)) : (k.va.L(), k.bias.h(1), z.U());
                            if (q) return I = k.va, f && (k.Bc.L(), I.h(0), D.set(K), D.V("u14", r, r), Q.l(!1, !1), I = k.Bc), t && (k.Dc.v(), D.set("s24"), D.V("u18", l, E / l), I.h(0), Q.l(!1, !1), I = k.Dc), I.h(0), I;
                            var L = k.va;
                            if (a.normalize || n.yb) u = a.normalize, D.set(n.yb ? "s9" : "s8"), D.I("u10", u ? r : 1), k.Cc.L(), L.h(0), Q.l(!1, !1), L =
                                k.Cc;
                            u = null;
                            switch (n.type) {
                                case "cpuRGBA2Float":
                        ...
                        kg: function(u) {
                            ...
                            d();
                            u = "undefined" !== typeof a.classesCount && a.classesCount ? a.classesCount :
                                a.size * a.size;
                            for (var I = 0, L = 0, v = 0; I < u; ++I) n.buffer.push(L + (a.size - 1 - v) * a.size), n.results.push([-1, -1, -1, -1]), ++L, L === a.size && (L = 0, ++v);
                            n.yb = "gpuRawAvg" === n.type || "cpuMeanFloat" === n.type;
                            if (a.normalize || n.yb) k.Cc = aa.instance({
                                isFloat: !0,
                                isPot: !0,
                                width: a.size
                            })
        ...
        dc = function() {
            return {
                instance: function(a) {
                    for (var c = a.fromLayerSize, d = a.toLayerSize, h = a.toSparsity, k = h * d, p = k / c, q = c / d, n = 0, l = 0, t = 0, w = Array(h * d * h * d * 4), y = Array(h * d * h * d * 4), x = Array(c * c), r = 0; r < x.length; ++r) x[r] = 0;
                    r = Math.floor(h / 2);
                    for (var F = .5 / d, C = .5 / c, f = .5 / k, E = 0; E < d; ++E)
        ...
        ec = function() {
            return {
                instance: function(a, c) {
                    ...
                    D.Ze(w) || (a = Xb.cf(c, "gl_FragColor", "gl_FragColor"), h = [{
                        type: "1f",
                        name: "u8",
                        value: h
                    }, {
                        ...
                        name: "u9",
                        value: d
                    }), d = [(n ? q : k).toFixed(1), a], n && d.push(l.toFixed(1)), D.xf(n ? "s47" : "s46", w, d), D.T(w, h.concat([{
                        type: "1i",
                        name: "u6",
                        value: 0
                    }, {
                ...
                instance: function(a) {
                    ...
                    return {
                        process: function(y) {
                            ...
                            Q.l(k, !1);
                            D.set("s44");
                            for (var x = 0; x < c; ++x) p.v(), D.V("u14", w, 0), Q.l(k, !1), n.v(), l.h(0), Q.l(k, !1), q.v(), p.h(0), D.V("u14", 0, w), Q.l(k, !1), l.v(), n.h(0), Q.l(k, !1), x !== c - 1 && q.h(0);
                            D.set("s45");
                            t.v();
                            y.h(0);
                            q.h(1);
            ...
            return {
                instance: function(a) {
                    ...
                    var l = "uniform sampler2D u34,u35,u36,u37;const float f=1.1111;const vec3 g=vec3(1.);const float h=2.2222;varying vec2 vv0;void main(){vec3 a=texture2D(u34,vv0).rgb;float c=texture2D(u35,vv0).r,d=texture2D(u36,vv0).r,i=texture2D(u37,vv0).r,j=a.r*a.r;vec3 b=vec3(c,d,i),k=max(g*f,abs(vec3(j)-b*b)),l=sqrt(k);gl_FragColor=vec4(a.r,h*(a-b)/l);}".replace("1.1111",
                            d.pa.toFixed(4)).replace("2.2222", d.gain.toFixed(4)),
                        t = {
                            u1: 0
                        };
                    D.fb([{
            ...
            return {
                instance: function(a) {
                    ...
                    var d = Object.assign({
                        ...
                        p = c(!1),
                        q = c(!0);
                    a = "uniform sampler2D u1;const float e=1.1111,g=2.2222;uniform vec2 u33;varying vec2 vv0;void main(){vec3 b=vec3(0.);float c=0.;for(float a=-e;a<=e;a+=1.){vec2 i=u33*a,j=vv0+i*g;float d=1.2*a/e,f=exp(-d*d);b+=f*texture2D(u1,j).rgb,c+=f;}b/=c,gl_FragColor=vec4(b,1.);}".replace("1.1111",
                        Math.round((d.ga - 1) / 2).toFixed(2)).replace("2.2222", (1 / d.u).toFixed(6));
                    var n = "uniform sampler2D u0,u38;const float f=1.1111;const vec3 g=vec3(1.);const float h=2.2222;varying vec2 vv0;void main(){vec4 a=texture2D(u0,vv0);vec3 c=texture2D(u38,vv0).rgb;float d=a.a*a.a;vec3 b=c.rgb,i=max(g*f,abs(vec3(d)-b*b)),j=sqrt(i);gl_FragColor=vec4(a.a,h*(a.rgb-b)/j);}".replace("1.1111", d.pa.toFixed(4)).replace("2.2222", d.gain.toFixed(4)),
                        l = {
                            u1: 0
                        };
                    D.fb([{
        ...
        bc = function() {
            return {
                instance: function(a) {
                    ...
                    if (d.Za) {
                        var l = "uniform sampler2D u1;const float e=1.1111,g=2.2222;uniform vec2 u33;varying vec2 vv0;void main(){vec4 b=vec4(0.);float c=0.;for(float a=-e;a<=e;a+=1.){vec2 i=u33*a,j=vv0+i*g;float d=1.2*a/e,f=exp(-d*d);b+=f*texture2D(u1,j),c+=f;}gl_FragColor=b/c;}".replace("1.1111", Math.round((d.ga - 1) / 2).toFixed(2)).replace("2.2222", (1 / d.u).toFixed(6)),
                            t = "uniform sampler2D u0,u38;const float f=1.1111;const vec4 g=vec4(1.);const float h=2.2222;varying vec2 vv0;void main(){vec4 a=texture2D(u0,vv0),c=texture2D(u38,vv0),d=a*a,b=c,i=max(g*f,abs(d-b*b)),j=sqrt(i);gl_FragColor=h*(a-b)/j;}".replace("1.1111",
                                d.pa.toFixed(4)).replace("2.2222", d.gain.toFixed(4));
                        n.push({
                            id: "s60",
                            name: "_",
                    ...
                    return {
                        process: function() {
                            ...
                            h.L();
                            Q.l(d.Z, !1);
                            d.Za ? (D.set("s60"), D.V("u33", 1, 0), k.v(), h.h(0), Q.l(!1, !1), D.V("u33", 0, 1), p.v(), k.h(0), Q.l(!1, !1), D.set("s61"), q.v(), h.h(0), p.h(1), Q.l(!1, !1), q.h(0)) : h.h(0)
                        },
                        lf: function() {
                            return 2 - d.Ec
                        },
        ...
        X = {
            ...
            lg: function(a, c) {
                window.addEventListener("beforeunload", function() {
                    c && c.getTracks && c.getTracks().forEach(function(d) {
                        c.removeTrack(d)
                    });
            ...
            Pe: function(a) {
                ...
                a.video.width && a.video.height && (a.video.width.ideal &&
                    a.video.height.ideal && d(function(x) {
                ...
                a.video.facingMode && (d(function(x) {
                    delete x.video.facingMode;
                    return x
                }), a.video.width && a.video.height && d(function(x) {
                    X.qe(x);
                    delete x.video.facingMode;
                    return x
                }));
            ...
            te: function(a, c, d) {
                return null === a ? Promise.resolve() : new Promise(function(h, k) {
            ...
            yd: function(a, c, d, h) {
                ...
                var p = !1;
                return navigator.mediaDevices.getUserMedia(h).then(function(q) {
                    function n() {
                        setTimeout(function() {
                            if (a.currentTime) {
                                var t = a.videoHeight;
                    ...
                    function l() {
                        ...
                        var t = a.play();
                        X.Sd(a);
                        "undefined" === typeof t ? n() : t.then(function() {
                            n()
                        }).catch(function() {
            ...
            get: function(a, c, d, h) {
                ...
                X.Me(h).then(function() {
                    X.yd(a, c, function() {
                        function k(q) {
                            if (0 ===
                                q.length) d("NO_VALID_MEDIASTREAM_FALLBACK_CONSTRAINTS");
                            else {
                                var n = q.shift();
                                X.yd(a, c, function() {
                                    k(q)
            ...
            Me: function(a) {
                ...
                return d && 0 !== d.length ? new Promise(function(h) {
                    X.zd(function(k) {
                        k ? (k =
                            k.find(function(p) {
                                var q = p.label;
                                return q ? d.some(function(n) {
                                    return q.includes(n)
                                }) : !1
                            })) ? (a.video.deviceId = {
                            exact: k.deviceId
                        }, h("SUCCESS")) : h("NO_PREFERRED_DEVICE_FOUND") : h("NO_DEVICES_FOUND")
                    })
            ...
            var c = {
                ...
                F = {
                    ...
                    Qb: function(C) {
                        ...
                        C - p > h.tg && 5 < ++q && (f = h.k, n = n * (1 - f) + (k < h.rb[0] ? l - 1 : k > h.rb[1] ? l + 1 : l) * f, Math.abs(n - l) > 1 - h.Sf && (f = Math.min(Math.max(Math.round(n), 0), h.n - 1), f !== l && (n = l = f, k = (h.rb[1] - h.rb[0]) / 2)), p = C)
                    },
        ...
        Ma = function() {
            ...
            function d(v) {
                A.Ia && null !== F && (v -= C, v = Math.min(Math.max(v, r.hd[0]), r.hd[1]), C += v, p(), g.isEnabled && g.$a && A.$ && C - g.rc > r.Wc && (t(), g.rc = C), F(C))
            }
            ...
            function q(v) {
                v && !A.$ ? (A.$ = !0, E && qa.Sc(), f.port.postMessage("STOP"), Y.se(!0),
                    c()) : !v && A.$ && (A.$ = !1, E && qa.Ic(1), Y.se(!1), f.port.postMessage("START"))
            }
            ...
            function t() {
                ...
                Y.flush();
                y().then(function(m) {
                    0 === m || isNaN(m) ? (g.isEnabled = !1, console.log("WARNING in benchmark_GPUClock: WebGL timer queries is not working properly. timeElapsedNs =",
                        m)) : (m = r.ve * r.Vc * 1E3 / m, g.Ub = (g.Ub + 1) % r.Ma, g.sc[g.Ub] = m, ++g.Od > r.Ma && (g.Db.set(g.sc), g.Db.sort(function(H, M) {
                        return H - M
                    }), m = g.Db[Math.floor(r.Ma / 2)], g.pb = Math.max(g.pb, m), r.Uc(m / g.pb)), g.$a = !0)
                }).catch(function() {
                    g.$a = !0
                })
            }
            ...
            function w(v) {
                ...
                e ? v(!O) : setTimeout(w.bind(null, v), .1)
            }
                ...
                L = {
                    A: function(v) {
                        ...
                        if (null !== r.Uc) {
                            ...
                            if (O = v.getExtension("EXT_disjoint_timer_query") || v.getExtension("EXT_disjoint_timer_query_webgl2")) {
                                ...
                                var N = l(v, v.VERTEX_SHADER, "attribute vec4 a0;void main(){gl_Position=a0;}"),
                                    e = l(v, v.FRAGMENT_SHADER,
                                        "precision lowp float;uniform float u39;void main(){vec4 a=u39*vec4(1.,2.,3.,4.);for(int b=0;b<666;b+=1)a=cos(a);gl_FragColor=a;}".replace("666", r.Vc.toString())),
                                    m = v.createProgram();
                                v.attachShader(m, N);
                                v.attachShader(m, e);
                                v.linkProgram(m);
                                ...
                                v.bufferData(v.ARRAY_BUFFER, new Float32Array([.5, .5, 0, 1]), v.STATIC_DRAW);
                        ...
                        if (r.Id) {
                            ...
                            v && ("onvisibilitychange" in document ? document.addEventListener("visibilitychange", n) : (window.addEventListener("blur", I), window.addEventListener("focus", u)), window.addEventListener("pagehide",
                                I), window.addEventListener("pageshow", u), A.oc = !0)
                        }
                        E = "undefined" !== typeof qa
                    },
                    m: function() {
                        k();
                        A.oc && ("onvisibilitychange" in document ? document.removeEventListener("visibilitychange", n) : (window.removeEventListener("blur", I), window.removeEventListener("focus", u)), window.removeEventListener("pagehide", I), window.removeEventListener("pageshow", u), A.oc = !1);
                ...
                A: function(y) {
                    ...
                    for (var E = 0; E < d.Vd; ++E) {
                        ...
                        for (var L = 1 + (1 - z - z) / u, v = 1 + (1 - g - g) / I, O = 0; O < v; ++O)
                            for (var N = g + O * I, e = N - .5, m = 0; m < L; ++m) {
                                var H = z + m * u,
                                    M = H - .5;
        ...
        da = function() {
            ...
            function d(f, E, K) {
                for (var A = f.length; F.length < A;) F.push({
                    oa: [0, 0],
                    Eb: [0, 0],
                    ia: [0, 0],
                    xa: 0,
            ...
            function k(f, E, K, A) {
                ...
                return f.some(function(u, I) {
                    if (!(u = I === K || z.ua > u.ua ||
                            3 > u.ua || !(0 < a(z.x, z.ca * r, u.x, u.ca * r)) || !(0 < a(z.y, z.ca * A * r, u.y, u.ca * A * r)))) {
                        u = F[I];
                        g.scale > u.scale ? I = g : (I = u, u = g);
                        for (var L = 0, v = 0, O = n.We, N = 0; N < O; ++N)
                            for (var e = ((N + .5) / O * 2 - 1) * u.oa[1], m = 0; m < O; ++m) {
                                var H = ((m + .5) / O * 2 - 1) * u.oa[0],
            ...
            var q = {
                ...
                C = {
                    ...
                    Ue: function(f) {
                        for (var E = new Float32Array(f.length * n.O), K = 0, A; K < n.O; ++K)
                            for (A = 0; A < f.length; ++A) E[K * f.length + A] = f[A];
                        return E
                    },
                    fc: function(f) {
                        for (var E = [], K = 0; K < n.O; ++K) {
                            ...
                            for (g in u) {
                                ...
                                var v = u[g];
                                var O = typeof v;
                                v = ["string", "boolean", "number"].includes(O) ? v : "object" !== O ? null : ArrayBuffer.isView(v) ? v.slice() : JSON.parse(JSON.stringify(v));
                                I[L] = v
                            }
                            z.call(A, I)
                        }
        ...
        yb = function() {
            ...
            return {
                Ye: function(c, d, h) {
                    return d.isDetected ? Math.floor(d.s * c) : (c = Math.floor(Math.log2(c / 4)), c = Math.min(Math.max(c, 4), 9), Math.max(h, Math.pow(2, c)))
                },
                instance: function(c) {
        ...
        ea = {
            ...
            Pf: .3,
            ng: {
                translationFactorRange: [.002, .01],
                rotationFactorRange: [.015, .1],
                qualityFactorRange: [.8,
                    .98
                ],
                alphaRange: [.04, 1],
        ...
        sb = {
            ...
            init: function(a) {
                function c() {
                    na !== ja.error && 2 === ++h && (Ka(), Bb(), Ja(), S.Ra && (na = ja.ready, S.Ra(!1, {
                        GL: b,
                        canvasElement: S.ha,
                ...
                a.videoSettings && a.videoSettings.videoElement ?
                    bb(a.videoSettings.videoElement, c) : (a.videoSettings && Object.assign(pa, a.videoSettings), Db(a.onWebcamAsk, a.onWebcamGet, function(k) {
                        bb(k, c)
                    }));
                Tb(function(k) {
                    if (!Ub()) return !1;
                    ...
                    D.fb([{
                        ...
                        name: "_",
                        za: "attribute vec2 a0;void main(){gl_Position=vec4(a0,0.,1.);}",
                        g: "uniform sampler2D u46;uniform float u51;const vec4 e=vec4(.25);const vec3 f=vec3(.5);void main(){float a=dot(e,texture2D(u46,vec2(.125,.875))),b=dot(e,texture2D(u46,vec2(.375,.875))),c=dot(e,texture2D(u46,vec2(.625,.875))),d=dot(e,texture2D(u46,vec2(.625,.625)));vec3 g=vec3(a,b,c)*.5+f;gl_FragColor=vec4(g,d*u51);}",
                        i: ["u46", "u51"]
                    }, {
                        id: "s67",
                        name: "_",
                        za: "attribute vec2 a0;void main(){gl_Position=vec4(a0,0.,1.);}",
                        g: "uniform sampler2D u46;const vec4 e=vec4(.25);void main(){float a=dot(e,texture2D(u46,vec2(.375,.375))),b=dot(e,texture2D(u46,vec2(.625,.375))),c=dot(e,texture2D(u46,vec2(.875,.375))),d=dot(e,texture2D(u46,vec2(.125,.125)));gl_FragColor=vec4(a,b,c,d);}",
                        i: ["u46"]
                    }, {
                        id: "s62",
                        name: "_",
                        g: "uniform sampler2D u41;uniform vec2 u53;uniform float u54;varying vec2 vv0;void main(){float f=step(.5,mod(gl_FragCoord.y+1.5,2.)),c=step(.33,vv0.x);vec4 a=texture2D(u41,vv0+u53);a.a=mix(a.a*u54,a.a,c);vec4 d=floor(255.*a),g=255.*(255.*a-d),b=mix(d,g,f)/255.;b.x=mix(step(a.x,1.5),b.x,c),gl_FragColor=b;}",
                        i: ["u41", "u54", "u53"]
                    }]);
                    zb();
                    ...
                    Ca = da.fc({
                        ...
                        ry: 0,
                        rz: 0,
                        expressions: new Float32Array(V.ba)
                    });
                    da.fc({
                        dx: 0,
                        dy: 0,
            ...
            update_videoSettings: function(a) {
                wb();
                return new Promise(function(c, d) {
                    X.te(J.element, !1, J.Sa).then(function() {
                        Object.assign(pa, a);
            ...
            toggle_slow: function(a) {
                Za() && na === ja.play && (a && !S.Bb ? (S.Yd = S.ea, ba.nDetectsPerLoop = 1, this.set_animateDelay(ea.xg), S.Bb = !0) : !a && S.Bb && (ba.nDetectsPerLoop = -1, this.set_animateDelay(S.Yd), S.Bb = !1))
            },
            ...
            set_scanSettings: function(a) {
                Object.assign(ba, a); - 1 !== ba.nDetectsPerLoop ? qa.Ic(ba.nDetectsPerLoop) : qa.Sc();
                mb();
                lb()
            },
